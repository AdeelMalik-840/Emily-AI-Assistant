 ...
 * belongs to the exact item currently under resolution. A mismatched item,
 * an expired record, or an invalid duration all yield null -- never a
 * fallback guess.
 *
 * @param {unknown} raw
 * @param {{ itemId?: string | null, nowMs?: number }} [opts]
 * @returns {Record<string, unknown> | null}
 */
